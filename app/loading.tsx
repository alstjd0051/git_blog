  ...
  return (
    <div className="mx-auto max-w-4xl px-6">
      ...
      <section className="py-20 sm:py-28">
        <div className="mb-3 h-5 w-20 animate-pulse rounded bg-white/8" />
        <div className="h-12 w-3/4 animate-pulse rounded bg-white/8" />
        <div className="mt-4 h-6 w-2/3 animate-pulse rounded bg-white/6" />
        <div className="mt-2 h-6 w-1/2 animate-pulse rounded bg-white/6" />
        <div className="mt-8 flex gap-4">
          <div className="h-12 w-32 animate-pulse rounded-full bg-blue-500/15" />
          <div className="h-12 w-24 animate-pulse rounded-full bg-white/6" />
        </div>
      </section>
